...
namespace Language_ru {
  ...
  LSTR MSG_OUTAGE_RECOVERY                  = _UxGT("Восст. при сбое");
  ...
  LSTR MSG_CUSTOM_PRINT_AGAIN                     = _UxGT("Повторить");
  LSTR MSG_CUSTOM_PRINT_TIME                      = _UxGT("Время печати: ");
  LSTR MSG_CUSTOM_MMPERSEC_SPEED                  = _UxGT("мм/с");
  LSTR MSG_CUSTOM_MILIMETERS                      = _UxGT("мм");
  LSTR MSG_CUSTOM_PRINTING_FINISHED               = _UxGT("Печать окончена");
  LSTR MSG_CUSTOM_TOO_COLD                        = _UxGT("Низк.темп");
  LSTR MSG_CUSTOM_WIFI_NOT_CONNECTED              = _UxGT("Нет подключения к Wi-Fi");
  LSTR MSG_CUSTOM_LOAD_FROM_WIFI_TXT              = _UxGT("Загрузить wifi.txt");
  LSTR MSG_CUSTOM_PRINT_IS_ACTIVE                 = _UxGT("Идет печать");
  LSTR MSG_CUSTOM_BED_MESH                        = _UxGT("Карта стола");
  LSTR MSG_CUSTOM_OFFSET                          = _UxGT("Смещение");
  LSTR MSG_CUSTOM_STOPPING_EXTRUDER               = _UxGT("Остановлено");
  LSTR MSG_CUSTOM_INPUT_200_MILIMETERS            = _UxGT("Выдавл. 200 мм");
  LSTR MSG_CUSTOM_FILAMENT_PRESETS                = _UxGT("2. Пресеты филаментов");
  LSTR MSG_ADVANCED_SETTINGS                      = _UxGT("1. Другие настройки");
  LSTR MSG_CUSTOM_BACK                            = _UxGT("<- Назад");

  LSTR MSG_CONFIGURATION                          = _UxGT("<- Назад");
  LSTR MSG_MAIN                                   = _UxGT("<- Назад");
  LSTR MSG_MODEL_FAN                              = _UxGT("Обдув детали");
  LSTR MSG_PREHEAT_M_SETTINGS                     = _UxGT("Настр.нагрев $");

  LSTR MSG_MPC_AUTOTUNE                           = _UxGT("Калибровка MPC");
