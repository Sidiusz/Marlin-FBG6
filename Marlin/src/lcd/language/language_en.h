...
namespace Language_en {
  ...
  //LSTR MSG_ADVANCED_SETTINGS              = _UxGT("1. Advanced Settings");
  ...
  LSTR MSG_PID_USE_MPC                    = _UxGT("Err: Try M306 T");
  ...
  LSTR MSG_CUSTOM_PRINT_AGAIN                     = _UxGT("Pring again");
  LSTR MSG_CUSTOM_PRINT_TIME                      = _UxGT("Print time:");
  LSTR MSG_CUSTOM_MMPERSEC_SPEED                  = _UxGT("mm/s");
  LSTR MSG_CUSTOM_MILIMETERS                      = _UxGT("mm");
  LSTR MSG_CUSTOM_PRINTING_FINISHED               = _UxGT("Printing finished");
  LSTR MSG_CUSTOM_TOO_COLD                        = _UxGT("Too Cold");
  LSTR MSG_CUSTOM_WIFI_NOT_CONNECTED              = _UxGT("Wi-Fi not connected");
  LSTR MSG_CUSTOM_LOAD_FROM_WIFI_TXT              = _UxGT("Load from wifi.txt");
  LSTR MSG_CUSTOM_PRINT_IS_ACTIVE                 = _UxGT("Print is active");
  LSTR MSG_CUSTOM_BED_MESH                        = _UxGT("Bed Mesh");
  LSTR MSG_CUSTOM_OFFSET                          = _UxGT("Offset");

  LSTR MSG_CUSTOM_STOPPING_EXTRUDER               = _UxGT("Stopping Extruder");
  LSTR MSG_CUSTOM_INPUT_200_MILIMETERS            = _UxGT("Input 200 mm");

  LSTR MSG_CUSTOM_FILAMENT_PRESETS                = _UxGT("2. Filament presets");
  LSTR MSG_CUSTOM_BACK                            = _UxGT("<- Back");

  LSTR MSG_ADVANCED_SETTINGS                      = _UxGT("1. Advanced Settings");
  LSTR MSG_CONFIGURATION                          = _UxGT("<- Back");
}
